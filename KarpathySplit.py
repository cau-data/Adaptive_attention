...
val = json.load( open('/data/TransientData/MSCOCO/annotations/captions_val2014.json', 'r') )
train = json.load( open('/data/TransientData/MSCOCO/annotations/captions_train2014.json', 'r') )
...
for subset in split:
    ...
    json.dump( json_data[ subset ], open( '/data/TransientData/MSCOCO/annotations/karpathy_split_' + subset + '.json', 'w' ) )
