...
if __name__ == '__main__':
    ...
    parser.add_argument('--vocab_path', type=str, default='/data/TransientData/MSCOCO/vocab.pkl',
                        help='path for vocabulary wrapper')
    parser.add_argument('--image_dir', type=str, default='/data/TransientData/MSCOCO/resized' ,
                        help='directory for resized training images')
    parser.add_argument('--caption_path', type=str,
                        default='/data/TransientData/MSCOCO/annotations/karpathy_split_train.json',
                        help='path for train annotation json file')
    parser.add_argument('--caption_val_path', type=str,
                        default='/data/TransientData/MSCOCO/annotations/karpathy_split_val.json',
    ...
    parser.add_argument( '--batch_size', type=int, default=40 ) # on cluster setup, 60 each x 4 for Huckle server
